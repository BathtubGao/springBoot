 ...
 * 复制
 * 说明：
 * 由于 D:\cfmwafhhgeyawnool 649的文件名长度超过了16个字符，达到了17，所以第一个字符'c'应该被忽略。
 * 记录 F:\fop\ywzqaop 631和 F:\yay\jc\ywzqaop 631由于文件名和行号相同，因此被视为同一个错误记录，哪怕它们的路径是不同的。
...
public class ErrorRecord {
    public static void main(String[] args) {
        ...
        while (sc.hasNext()) {
            ...
            String str = index2 - index1 <= 16 ? input.substring(index1 + 1) : input.substring(index2-16);
